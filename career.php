...
<head>
  ...
  <title>.NET Custom Software Development</title>
  ...
  <div class="container pt-11 pt-md-13 pb-11 pb-md-19 pb-lg-22 text-center">
    <div class="row">
      <div class="col-lg-8 col-xl-7 col-xxl-6 mx-auto" data-cues="slideInDown" data-group="page-title">
        <h1 class="display-3 mb-4 px-md-15 px-lg-0">Join <span class="text-primary">our team</span> to help shape the future of development.</h1>
        <p class="lead fs-18 lh-sm mb-7 mx-md-13 mx-lg-10">We are a creative company that focuses on long term relationships with customers.</p>
...
<!-- /section -->
<section class="wrapper bg-light">
  <div class="container pt-2 pt-md-5 pb-9 pb-md-11">
    <figure class="rounded mt-md-n21 mt-lg-n23 mb-14" data-cue="slideInDown" data-delay="900"><img src="./assets/img/photos/career.jpg" srcset="./assets/img/photos/career.jpg" alt="" /></figure>
  </div>
  <!-- /.container -->
</section>
<!-- /section -->
<!-- /section -->
    ...
    <section class="wrapper bg-light">
      <div class="container">
        <div class="row text-center" id="open-position">
        ...
        <!-- /.row -->
		  <div class="row gy-6">
			   <?php 
					include "db.php"; 
	  $result = mysqli_query($conn,"SELECT * FROM career ORDER BY uid DESC")or
die("Table Errors Contact admin support");
					while ($db_field = mysqli_fetch_assoc($result)) { ?>
 <div class="col-md-6 col-lg-4">
				<a href="career-job.php?alias=<?php print $db_field['alias']; ?>" class="card shadow-lg lift h-100">
					<div class="card-body p-5 d-flex flex-row">
						<div>
							<?php 
								$ran = array("bg-red","bg-ash","bg-fuchsia","bg-grape","bg-purple","bg-pink","bg-sky","bg-orange");									 
							$color = $ran[array_rand($ran)];
							?>
							<span class="avatar <?php echo $color; ?> text-white w-11 h-11 fs-20 me-4"><?php print $db_field['job_c']; ?></span>
						</div>
						<div>
							<span class="badge bg-pale-blue text-blue rounded py-1 mb-2"><?php print $db_field['job_type']; ?></span>
							<h4 class="mb-1"><?php print $db_field['title']; ?></h4>
							<?php if($db_field['exp']!=''){?>
								<span class="badge bg-pale-dark text-dark rounded py-1 mb-2"><?php print $db_field['exp']; ?></span>
							<?php }else{ ?>
								<span class="badge bg-pale-dark text-dark rounded py-1 mb-2">Fresher</span>
							<?php } ?>
							
							<p class="mb-0 text-body"><?php print $db_field['place']; ?></p>
						</div>
					</div>
				</a>
			</div>
...
<!-- /section -->
        ...
        <div class="row mt-11 mb-11">
          <div class="col-lg-6 col-xl-5 mx-auto text-center">
            <h2 class="display-6 mb-8">Can't find the right position?</h2>           
            <a href="#" class="btn btn-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#modal-signup">Get in Touch</a>
          </div>
          <!-- /column -->
        </div>
        <!-- /.row -->
